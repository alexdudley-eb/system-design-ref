"""
DEPRECATED: This file has been split into modular files for better maintainability.

Please import from flashcard_questions module instead:
    from flashcard_questions import CONCEPT_QUESTIONS, PATTERN_QUESTIONS, NUMBERS_QUESTIONS

New structure:
    flashcard_questions/
        __init__.py - Re-exports all questions
        concept_questions.py - 25 distributed systems concept questions
        pattern_questions.py - 15 design pattern questions
        numbers_questions.py - 15 scale/latency/performance questions
...
# Type alias for pattern questions (can be either variant)
